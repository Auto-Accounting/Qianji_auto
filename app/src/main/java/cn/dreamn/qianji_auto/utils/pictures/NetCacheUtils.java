...
public class NetCacheUtils {
    ...
    public NetCacheUtils(LocalCacheUtils localCacheUtils, MemoryCacheUtils memoryCacheUtils, Context context, Handler mHandler) {
        mLocalCacheUtils = localCacheUtils;
        mMemoryCacheUtils = memoryCacheUtils;
        mContext = context; this.mHandler=mHandler;
    }
