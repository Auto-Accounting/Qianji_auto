...
public class localFragment extends BaseFragment {
    ...
    private void OnItemClickListen(View view, int position) {
        ...
        BottomArea.list(getContext(), String.format(getString(R.string.assert_change), cate.getString("name")), Arrays.asList(getString(R.string.del), getString(R.string.edit_default), getString(R.string.edit_js), getString(R.string.upload_cloud), disable), new BottomArea.ListCallback() {
            @Override
