...
public class identifyRegulars {
    ...
    public static void setSort(int id, int sort) {
        TaskThread.onThread(() -> DbManger.db.IdentifyRegularDao().setSort(id, sort));
    }

    public static void clear(String identify) {
        TaskThread.onThread(() -> DbManger.db.IdentifyRegularDao().clean(identify));
    }
    ...
    public static void clear(String identify, String fromApp) {
        TaskThread.onThread(() -> DbManger.db.IdentifyRegularDao().clean(identify, fromApp));
    }
}
