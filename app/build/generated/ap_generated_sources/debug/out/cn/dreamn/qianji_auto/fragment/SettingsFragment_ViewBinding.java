...
public class SettingsFragment_ViewBinding implements Unbinder {
  ...
  public SettingsFragment_ViewBinding(SettingsFragment target, View source) {
    ...
    target.set_alipay_money = Utils.findRequiredViewAsType(source, R.id.set_alipay_money, "field 'set_alipay_money'", SuperTextView.class);
    target.set_alipay_ant = Utils.findRequiredViewAsType(source, R.id.set_alipay_ant, "field 'set_alipay_ant'", SuperTextView.class);
  ...
  public void unbind() {
    ...
    target.set_alipay_money = null;
    target.set_alipay_ant = null;
