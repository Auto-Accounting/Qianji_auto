...
public class Others {
    ...
    //获取所有的js
    public static String getOtherRegularJs(String Body) {
        StringBuilder smsList = new StringBuilder();
        Other[] others = DbManger.db.OtherDao().load();
        for (Other value : others) {

            String[] s = getNum(value.num);
    ...
    public static Other[] getAll() {
        return DbManger.db.OtherDao().loadAll();
    }

    public static void deny(int id) {
        DbManger.db.OtherDao().deny(id);
    }

    public static void enable(int id) {
        DbManger.db.OtherDao().enable(id);
    }
    ...
    public static void del(int id) {
        DbManger.db.OtherDao().delete(id);
    }

    public static void setSort(int id, int sort) {
        DbManger.db.OtherDao().setSort(id, sort);
    }

    public static void clear() {
        DbManger.db.OtherDao().clean();
    }
}
