package net.ankio.timepicker.builder;
...
import net.ankio.timepicker.listener.OnTimeSelectChangeListener;
...
public class TimePickerBuilder {
    ...
    public TimePickerView build(boolean isFloat) {
        return new TimePickerView(isFloat, mPickerOptions);
    }
}
