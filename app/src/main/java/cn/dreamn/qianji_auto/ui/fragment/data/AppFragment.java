 ...
 */
@Page(name = "App列表", anim = CoreAnim.slide)
public class AppFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        statusView.setOnEmptyViewConvertListener(viewHolder -> viewHolder.setText(R.id.empty_info, "没有任何App数据"));
        statusView.setOnLoadingViewConvertListener(viewHolder -> viewHolder.setText(R.id.load_info, "正在加载App数据"));
